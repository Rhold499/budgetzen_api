...
class UpdateBudgetDto extends (0, swagger_2.PartialType)(create_budget_dto_1.CreateBudgetDto) {
    amount;
    currency;
    month;
    year;
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: '500.00' }),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 3, description: 'Month (1-12)' }),
    (0, class_validator_1.IsOptional)(),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 'uuid-category-id' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsUUID)(),
    __metadata("design:type", String)
], UpdateBudgetDto.prototype, "categoryId", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: '0.8', description: 'Alert threshold (0.8 = 80%)' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsDecimal)({ decimal_digits: '0,2' }),
    __metadata("design:type", String)
], UpdateBudgetDto.prototype, "alertAt", void 0);
